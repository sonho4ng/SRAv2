# SRA: Span Representation Alignment for Model Distillation

This repository provides the implementation of **SRA**, a framework for cross-tokenizer knowledge distillation between teacher and student models.  
